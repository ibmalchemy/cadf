...
// | Name         | Type           | Required | Description   |
// |--------------+----------------+----------+---------------|
// | request      | Time Duration  | Yes      | request time  |
// | target       | Time Duration  | Yes      | target time   |
// | observer     | Time Duration  | Yes      | observer time |
//

type Latencies struct {
	Request  time.Duration `json:"request"`
	Target   time.Duration `json:"target"`
	Observer time.Duration `json:"observer"`
}
